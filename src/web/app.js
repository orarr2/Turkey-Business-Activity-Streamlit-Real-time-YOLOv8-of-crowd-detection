...
// ---- Active-learning curve (Model quality tab) -----------------------------
// One point per training run from /api/al-curve. Local-mode only: on the
// hosted dashboard the fetch 404s and the panel stays hidden.
